...
class Plotter:
    ...
    def generate_plot(self):
        ...
        ax.set_xlabel(self.xlabel, fontfamily='serif', fontweight='bold')
        ax.set_ylabel(self.ylabel, fontfamily='serif', fontsize=10, fontweight='bold')

        ax.set_xticklabels(ax.get_xticks(), fontweight='bold', fontsize=6)
    ...
    def save_plot(self, filename):
        ...
        fig.axes[0].set_xticklabels(x_labels, rotation='vertical', fontsize=6)  # Adjust rotation and fontsize
